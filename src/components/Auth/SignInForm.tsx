    ...
    <div className="min-h-screen bg-dark-bg flex items-center justify-center py-12 px-4">
      ...
      >
        ...
        <div className="text-center">
          ...
          <h2 className="mt-6 text-3xl font-bold text-dark-text">Welcome back</h2>
          <p className="mt-2 text-sm text-dark-muted">
            Don't have an account?{' '}
            <Link to="/auth/sign-up" className="text-electric-400 hover:text-electric-300 transition-colors">
              Sign up
            </Link>
          </p>
        </div>
